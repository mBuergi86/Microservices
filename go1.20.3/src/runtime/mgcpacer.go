...
// gcController implements the GC pacing handlers that determines
...
// startCycle resets the GC handlers's state and computes estimates
...
// resetLive sets up the handlers state for the next mark phase after the end
...
//
// It updates mark work accounting in the handlers by a duration of
