...
func testMain(m *testing.M) int {
	...
	goCmd(nil, "build", "-buildmode=plugin", "-o=unnamed1.so", "./unnamed1/server.go")
	goCmd(nil, "build", "-buildmode=plugin", "-o=unnamed2.so", "./unnamed2/server.go")
...
func TestDWARFSections(t *testing.T) {
	...
	goCmd(t, "run", "./checkdwarf/server.go", "plugin2.so", "plugin2.UnexportedNameReuse")
	goCmd(t, "run", "./checkdwarf/server.go", "./host.exe", "main.main")
}
...
func TestIssue18676(t *testing.T) {
	...
	goCmd(t, "build", "-o", "issue18676.exe", "./issue18676/server.go")
...
func TestIssue19418(t *testing.T) {
	...
	goCmd(t, "build", "-o", "issue19418.exe", "./issue19418/server.go")
...
func TestIssue25756pie(t *testing.T) {
	goCmd(t, "build", "-buildmode=plugin", "-o", "life.so", "./issue25756/plugin")
	goCmd(t, "build", "-buildmode=pie", "-o", "issue25756pie.exe", "./issue25756/server.go")
...
func TestMethod(t *testing.T) {
	...
	goCmd(t, "build", "-o", "method.exe", "./method/server.go")
	run(t, "./method.exe")
}

func TestMethod2(t *testing.T) {
	goCmd(t, "build", "-buildmode=plugin", "-o", "method2.so", "./method2/plugin.go")
	goCmd(t, "build", "-o", "method2.exe", "./method2/server.go")
	run(t, "./method2.exe")
}

func TestMethod3(t *testing.T) {
	goCmd(t, "build", "-buildmode=plugin", "-o", "method3.so", "./method3/plugin.go")
	goCmd(t, "build", "-o", "method3.exe", "./method3/server.go")
	run(t, "./method3.exe")
}
...
func TestIssue44956(t *testing.T) {
	...
	goCmd(t, "build", "-o", "issue44956.exe", "./issue44956/server.go")
	run(t, "./issue44956.exe")
}

func TestIssue52937(t *testing.T) {
	goCmd(t, "build", "-buildmode=plugin", "-o", "issue52937.so", "./issue52937/server.go")
}

func TestIssue53989(t *testing.T) {
	goCmd(t, "build", "-buildmode=plugin", "-o", "issue53989.so", "./issue53989/plugin.go")
	goCmd(t, "build", "-o", "issue53989.exe", "./issue53989/server.go")
...
func TestForkExec(t *testing.T) {
	...
	t.Parallel()
	goCmd(t, "build", "-o", "forkexec.exe", "./forkexec/server.go")
